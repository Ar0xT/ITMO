...
public class RemoveGreater extends CommandWithElement {
    ...
    public RemoveGreater(CollectionManager manager, BandRepository bandRepository) {
        super(manager);
    ...
    protected CommandResult executeInternal(CommandRequest request) {
        ...
        try {
            ...
            return new CommandResult("Removed " + deleted + " owned bands greater than the given band.", true);
        } catch (Exception e) {
